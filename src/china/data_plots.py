...
json_dir = os.path.join(china_data_dir, 'json')
...
fig = go.Figure(go.Choroplethmapbox(geojson=china,
                                    locations=covid19_data.region,
                                    z=covid19_data.confirmed_cases,
                                    colorscale='Jet',
                                    zmin=0, zmax=2000,
